      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-sm hover:text-cyan-400 transition">Residential Cleaning</a></li>
              <li><a href="#" className="text-sm hover:text-cyan-400 transition">Commercial Cleaning</a></li>
              <li><a href="#" className="text-sm hover:text-cyan-400 transition">Gutter Repairs</a></li>
              <li><a href="#" className="text-sm hover:text-cyan-400 transition">Fascia & Soffit Wash</a></li>
              <li><a href="#" className="text-sm hover:text-cyan-400 transition">Downpipe Unblocking</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2">
                ...
                <a href={PHONE_NUMBER_LINK} className="text-sm hover:text-cyan-400 transition">{PHONE_NUMBER_FORMATTED}</a>
              </li>
              <li className="flex items-start gap-2">
                <svg className="w-5 h-5 text-cyan-400 mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <a href={`mailto:${EMAIL}`} className="text-sm hover:text-cyan-400 transition">{EMAIL}</a>
              </li>
              <li className="flex items-start gap-2">
                <svg className="w-5 h-5 text-cyan-400 mt-0.5 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <span className="text-sm">Serving all of the UK</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-gray-400">
              © {new Date().getFullYear()} ClearFlow Gutters. All rights reserved.
            </p>
