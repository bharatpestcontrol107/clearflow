      ...
      <main className="min-h-screen">
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-20 md:py-32">
            <div className="max-w-4xl mx-auto text-center">
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-extrabold uppercase tracking-wide leading-tight mb-6">
                About ClearFlow Gutter Cleaning
              </h1>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="space-y-4 text-gray-700 leading-relaxed">
                  <p>
                    Welcome to <span className="font-semibold">ClearFlow Gutter Cleaning</span>, your local gutter cleaning and repair service. 
              ...
              <div className="relative aspect-4/3 rounded-2xl overflow-hidden shadow-2xl">
                <Image src="/images/service_gutter_cleaning.png" alt="ClearFlow team at work" fill className="object-cover" />
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white py-16 lg:py-24">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Ready to Experience the ClearFlow Difference?
            </h2>
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
              Get a free quote today and discover why thousands of customers trust ClearFlow for their gutter needs.
            </p>
