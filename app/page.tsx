          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-14">
            ...
            <div className="mt-10 grid md:grid-cols-3 gap-8">
              <div>
                ...
                <p className="mt-4 text-gray-700 text-sm leading-relaxed">
                  Get your roof and gutters checked by an expert with a <span className="font-semibold">FREE gutter inspection</span> by ClearFlow Gutter Cleaning. This popular gutter service ensures a thorough check of your roof and gutters which can help you identify any potential problems, and we can advise you how to put them right.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="mt-4 text-gray-700 text-sm leading-relaxed">
                  ClearFlow Gutter Cleaning has a reputation for fixing leaking and damaged gutters quickly. Our gutter repair service is always in <span className="font-semibold">high demand</span> as we are one of the few companies that provide you with <span className="font-semibold">12 months guarantee</span> for any gutter repair.
                </p>
              </div>
              ...
              <div>
                ...
                <p className="mt-4 text-gray-700 text-sm leading-relaxed">
                  A new rainwater guttering system installed to <span className="font-semibold">perfection</span>. ClearFlow Gutter Cleaning are registered installers of FreeFoam Plastics allowing us to supply and install quality uPVC gutters and down-pipes to the highest standard.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              <div className="group cursor-pointer">
                ...
                <p className="text-gray-600 text-center">Manchester • 2 days ago</p>
              </div>
              ...
              <div className="group cursor-pointer">
                ...
                <p className="text-gray-600 text-center">Bristol • 3 days ago</p>
              </div>
              ...
              <div className="group cursor-pointer">
                ...
                <p className="text-gray-600 text-center">Liverpool • 5 days ago</p>
              </div>
              ...
              <div className="group cursor-pointer">
                ...
                <p className="text-gray-600 text-center">Leeds • 1 week ago</p>
              </div>
              ...
              <div className="group cursor-pointer">
                ...
                <p className="text-gray-600 text-center">Sheffield • 10 days ago</p>
              </div>
            </div>
